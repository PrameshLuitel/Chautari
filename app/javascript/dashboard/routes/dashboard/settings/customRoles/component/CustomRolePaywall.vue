...
const isOnChautariCloud = useMapGetter('globalConfig/isOnChautariCloud');
...
const i18nKey = computed(() =>
  isOnChautariCloud.value ? 'PAYWALL' : 'ENTERPRISE_PAYWALL'
);
  ...
  <div class="w-full min-h-[12rem] relative">
    ...
    >
      <BasePaywallModal
        ...
        :i18n-key="i18nKey"
        :is-on-chatwoot-cloud="isOnChautariCloud"
