...
export function useBranding() {
  ...
  /**
   * Replaces "Chautari" in text with the installation name from global config
   * @param {string} text - The text to process
   * @returns {string} - Text with "Chautari" replaced by installation name
   */
  const replaceInstallationName = text => {
    ...
    return text.replace(/Chautari/g, installationName);
  };
