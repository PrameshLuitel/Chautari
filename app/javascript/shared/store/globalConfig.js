...
export const getters = {
  get: $state => $state,
  isOnChautariCloud: $state => $state.deploymentEnv === 'cloud',
  isACustomBrandedInstance: $state => $state.installationName !== 'Chautari',
  isAChautariInstance: $state => $state.installationName === 'Chautari',
};
